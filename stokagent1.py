...
if "all_active_tickers" in st.session_state:
    ...
    if st.button("🌐 הפק דוח מקיף ומלא (Bloomberg, TradingView, 13F & Quiver)", type="secondary"):
        with st.spinner(f"סוכן הרשת סורק כעת את Bloomberg, TradingView ונתוני Quiver Quant על {chosen_ticker}..."):
            ...
            1. site:bloomberg.com (Macro pressures, institutional updates, and supply chain bottlenecks).
            2. site:tradingview.com (Technical chart patterns, community trends, and oscillator consensus).
            3. site:quiverquant.com (Congressional & Political Trading - Check if any US Senators, House representatives, or corporate insiders have recently bought or sold shares of {chosen_ticker}).
